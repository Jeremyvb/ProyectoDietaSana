...
public class Persona {
    ...
    public void insertarDatosPersona(){
        ...
        for(int i=0 ;i < totalEjercicios; i++){
            ejercicios.InsertarDatosEjercicio();
            LEjercicios.add(ejercicios);
        }  
    ...
    public void imprimirAlimentosUsuario(String rutUsuario){
    
        for (int i = 0; i < personas.size(); i++) {
            if (personas.get(i).getRut().equals(rutUsuario)) {
                System.out.println("Ejercicio "+(i+1)+":");
                System.out.println("-Nombre ejercicio: "+personas.get(i).LEjercicios.get(i).getNombre());
                System.out.println("-Horas al día: "+personas.get(i).LEjercicios.get(i).getHorasAlDia());
            }
        }
    }
