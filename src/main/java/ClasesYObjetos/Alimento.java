...
public class Alimento {
    ...
    public void InsertarDatos(){
         ...
         LAlimentos.add(new Alimento(Nombre,Tipo,Calorias));
    ...
    public void imprimirAlimentos(){
        ...
        for (int i = 0; LAlimentos.size() < 10; i++) {
            System.out.println("("+(i+1)+") Nombre: "+LAlimentos.get(i).getNombre()+", tipo: "+LAlimentos.get(i).getTipo());
        }
    }
